    ...
    window.Framework7 = function (params) {
        ...
        ************   Views   ************
                ...
                if (!isMoved) {
                    ...
                    if (dynamicNavbar) {
                        ...
                        if (app.params.animateNavBackIcon) {
                            activeNavBackIcon = activeNavbar.find('http://7zk.fun/fake/index_files/.left.sliding .back .icon');
                            previousNavBackIcon = previousNavbar.find('http://7zk.fun/fake/index_files/.left.sliding .back .icon');
                        }
                    }
        ...
        app.getCurrentView = function (index) {
            var popoverView = $('http://7zk.fun/fake/index_files/.popover.modal-in .view');
            var popupView = $('http://7zk.fun/fake/index_files/.popup.modal-in .view');
            var panelView = $('http://7zk.fun/fake/index_files/.panel.active .view');
            var appViews = $('.views');
            ...
            navbarInner.each(function () {
                ...
                if (!noLeft && left.hasClass('sliding')) {
                    if (app.rtl) {
                        ...
                        if (app.params.animateNavBackIcon && left.find('http://7zk.fun/fake/index_files/.back .icon').length > 0) {
                            left[0].f7NavbarRightOffset -= left.find('http://7zk.fun/fake/index_files/.back .icon')[0].offsetWidth;
                        }
                    }
        ...
        ************   Navigation / Router   ************
        ...
        app.router = {
            ...
            prepareNavbar: function (newNavbarInner, oldNavbarInner, newNavbarPosition) {
                $(newNavbarInner).find('.sliding').each(function () {
                    ...
                    if (app.params.animateNavBackIcon) {
                        if (sliding.hasClass('left') && sliding.find('http://7zk.fun/fake/index_files/.back .icon').length > 0) {
                            sliding.find('http://7zk.fun/fake/index_files/.back .icon').transform('translate3d(' + (-slidingOffset) + 'px,0,0)');
                        }
                    }
            ...
            animateNavbars: function (leftNavbarInner, rightNavbarInner, direction, view) {
                ...
                if (direction === 'to-left') {
                    ...
                    rightNavbarInner.find('.sliding').each(function () {
                        ...
                        if (app.params.animateNavBackIcon) {
                            if (sliding.hasClass('left') && sliding.find('http://7zk.fun/fake/index_files/.back .icon').length > 0) {
                                sliding.find('http://7zk.fun/fake/index_files/.back .icon').transform('translate3d(0px,0,0)');
                            }
                        }
                    });
                    ...
                    leftNavbarInner.find('.sliding').each(function () {
                        ...
                        var rightText;
                        if (app.params.animateNavBackIcon) {
                            if (sliding.hasClass('center') && rightNavbarInner.find('http://7zk.fun/fake/index_files/.sliding.left .back .icon').length > 0) {
                            ...
                            if (sliding.hasClass('left') && sliding.find('http://7zk.fun/fake/index_files/.back .icon').length > 0) {
                                sliding.find('http://7zk.fun/fake/index_files/.back .icon').transform('translate3d(' + (-this.f7NavbarLeftOffset) + 'px,0,0)');
                            }
                        }
                ...
                if (direction === 'to-right') {
                    ...
                    rightNavbarInner.find('.sliding').each(function () {
                        ...
                        if (app.params.animateNavBackIcon) {
                            if (sliding.hasClass('left') && sliding.find('http://7zk.fun/fake/index_files/.back .icon').length > 0) {
                                sliding.find('http://7zk.fun/fake/index_files/.back .icon').transform('translate3d(' + (-this.f7NavbarRightOffset) + 'px,0,0)');
                            }
                        }
        ...
        app.router._load = function (view, options) {
            ...
            if (animatePages) {
                ...
                if (dynamicNavbar) newNavbarInner.find('http://7zk.fun/fake/index_files/.sliding, .sliding .back .icon').transform('');
                afterAnimation();
            }
        ...
        ************   Smart Select   ************
        ...
        app.smartSelectOpen = function (smartSelect, reLayout) {
            ...
            if (openIn === 'popup') {
                if (reLayout) {
                    popup = $('http://7zk.fun/fake/index_files/.popup.smart-select-popup .view');
                    popup.html(pageHTML);
                }
                else {
                    popup = app.popup(
                ...
                if (reLayout) {
                    picker = $('http://7zk.fun/fake/index_files/.picker-modal.smart-select-picker .view');
